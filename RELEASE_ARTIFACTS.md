...
- `evangelion-omarchy-rice-1.5.0.tar.gz`
- `evangelion-omarchy-rice-1.5.0.tar.gz.sha256`
...
./scripts/build-release verify ../evangelion-omarchy-rice-1.5.0.tar.gz
...
the v1.5.0 archive and checksum are published through the
