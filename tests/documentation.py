...
def main():
    ...
    for guide in ("INSTALL.md", "CONFIGURATION.md", "TROUBLESHOOTING.md", "UPGRADING.md",
                  ...
                  "RICE_HEALTH.md", "SNAPSHOTS.md", "SETTINGS.md", "WORKSPACES.md", "VISUAL_CUSTOMIZATION.md", "SCENES.md", "MEDIA_CONTROLS.md", "ACCESSIBILITY.md", "DISTRIBUTION_GUIDE.md", "MAINTAINING.md"):
